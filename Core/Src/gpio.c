...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, PUMP5_Pin|PUMP4_Pin|PUMP3_Pin|PUMP2_Pin
                          |PUMP1_Pin, GPIO_PIN_SET);
  ...
  /*Configure GPIO pins : PBPin PBPin PBPin PBPin
                           PBPin PBPin */
  GPIO_InitStruct.Pin = PUMP5_Pin|PUMP4_Pin|PUMP3_Pin|PUMP2_Pin
                          |PUMP1_Pin|GLASS_SCALE_SCK_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);
  ...
  /*Configure GPIO pin : PtPin */
  GPIO_InitStruct.Pin = GLASS_SCALE_DATA_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GLASS_SCALE_DATA_GPIO_Port, &GPIO_InitStruct);
